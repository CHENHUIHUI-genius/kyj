...
private void OnEnable()
{
    ...
    EventHandler.AfterSceneLoadedEvent += OnAfterSceneLoadedEvent;      // 订阅场景加载后事件：恢复物品栏
}
...
private void OnDisable()
{
    ...
    private void OnStartNewGameEvent()
    {
        Debug.Log("清空物品栏 - 开始新游戏");
        for (int i = 0; i < itemArray.Length; i++)
        {
            itemArray[i] = ItemName.None;
            EventHandler.CallUpdateUIEvent(null, i); // 清空UI
        }
    }
